 ...
 *            <filter-class>com.fiberhome.daml.pangu.scout.core.filters.ContentSecurityPolicyFilter</filter-class>
 *
 *            <init-param>
...
public class ContentSecurityPolicyFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) {
        ...
        sandboxSrc = getParameterValue(filterConfig, SANDBOX);
    ...
    private String getContentSecurityPolicy() {
        ...
        addSandoxDirectiveToContentSecurityPolicy(contentSecurityPolicy, sandboxSrc);
